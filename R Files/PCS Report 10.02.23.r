...
################ Read original files ####################
pre_final_product <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from vscode/2023/mfg_location_tab_10.02.2023.xlsx")

mfg_location_tab_raw <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.06.23/All PCS Projects - With MFG Locations (72).csv")
pcs_rnd_primary_pack_graphics <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.06.23/PCS R&D Primary & Pack Graphics (53).csv")
...
rnd_unique_ingredient_info <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.06.23/PCS R&D Unique Ingredients (54).csv")
master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.06.23/SRCH252225.csv")

################ Read Data Fixed files ####################
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.06.23/ProjectList_10_6_2023 8_39_45 AM.xlsx")
...
writexl::write_xlsx(mfg_location_tab, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from vscode/2023/10.02.2023/mfg_location_tab_10.02.2023.xlsx")
writexl::write_xlsx(list_of_dfs, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from vscode/2023/10.02.2023/pcs_data_10.02.2023.xlsx")
