...
################ Read original files ####################
mfg_location_tab_raw <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.30.23/All PCS Projects - With MFG Locations 10.30.23.csv")
pcs_rnd_primary_pack_graphics <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.30.23/PCS R&D Primary & Pack Graphics 10.30.23.csv")
...
rnd_unique_ingredient_info <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.30.23/PCS R&D Unique Ingredients 10.30.23.csv")
master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.30.23/SRCH335056.csv")

################ Read Data Fixed files ####################
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/10.30.23/ProjectList_10_30_2023 6_18_31 AM.xlsx")
...
comp <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 10.23.23.xlsx") # input Previous week's data
...
mfg_location_tab_raw %>% 
  janitor::clean_names() %>% 
  dplyr::filter(project_submitted_date >= as.Date("2023-10-22") & project_submitted_date <= as.Date("2023-10-29")) %>%  #### Input the past date to figure out new projects ####
...
writexl::write_xlsx(comp_update_2, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 10.30.23.xlsx")
writexl::write_xlsx(new_projects_mpi_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 10.30.2023.xlsx")
writexl::write_xlsx(clean_customer_new_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 10.30.2023.xlsx")

##############################################################################################################################################################
####################################### Now you go back to the .xlsx file & finish your manual work from PCS System ##########################################
##############################################################################################################################################################

comp <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 10.23.30.xlsx")
mpi <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 10.30.2023.xlsx")
clean_customer <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 10.30.2023.xlsx")
