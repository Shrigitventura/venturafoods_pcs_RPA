...
```{r}
mfg_location_tab_raw <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.08.2024/All PCS Projects - With MFG Loc.xlsx")

pcs_rnd_primary_pack_graphics <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.08.2024/PCS R&D Primary & Pack Graphics (1).xlsx")
...
rnd_unique_ingredient_info <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.08.2024/PCS R&D Unique Ingredients (1).xlsx")

master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.08.2024/SRCH316754.csv")
```

### Read Data Fixed files (Click play after inputting correct resources)
```{r}
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.08.2024/ProjectList_7_8_2024 6_21_56 AM.xlsx")
...
mfg_location_tab_raw %>% 
  ...
  dplyr::filter(project_submitted_date >= as.Date("2024-06-23") & project_submitted_date <= as.Date("2024-07-07")) %>%
...
```{r}
writexl::write_xlsx(comp_update_2, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 07.08.2024.xlsx")
writexl::write_xlsx(new_projects_mpi_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 07.08.2024.xlsx")
writexl::write_xlsx(clean_customer_new_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 07.08.2024.xlsx")
...
```{r}
comp <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 07.08.2024.xlsx")
mpi <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 07.08.2024.xlsx")
clean_customer <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 07.08.2024.xlsx")
```
...
mfg_location_tab_raw %>% 
  data.frame() %>% 
  janitor::clean_names() %>% 
  dplyr::rename(project_minimum_met = minimum_met) %>% 
  dplyr::select(project_number, project_status, project_name, requestor, project_submitted_date, project_type, pcs_product_name, business_channel, pcs_product_category,
                ...
                actual_completion_date, sku_label_being_replaced, limited_time_offer, estimated_probability_of_success,
                formula_request_type, sku_base_being_replaced, suggested_line_number, processing_attribute_type, suggested_deck,
                r_d_formula_number, requested_pack_size, new_sku_base, new_sku_label) -> mfg_location_tab
...
mfg_location_tab %>% 
  ...
  dplyr::mutate(desired_launch_date = as.Date(desired_launch_date)) %>% 
...
```{r}
writexl::write_xlsx(mfg_location_tab, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/07.08.2024/mfg_location_tab_07.08.2024.xlsx")

writexl::write_xlsx(list_of_dfs, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/07.08.2024/pcs_data_07.08.2024.xlsx")
