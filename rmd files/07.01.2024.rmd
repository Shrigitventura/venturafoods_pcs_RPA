...
```{r}
mfg_location_tab_raw <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.01.2024/All PCS Projects - With MFG Locations - 2024-06-10T090532.846 (1).xlsx")

pcs_rnd_primary_pack_graphics <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.01.2024/PCS R&D Primary & Pack Graphics.xlsx")
...
rnd_unique_ingredient_info <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.01.2024/PCS R&D Unique Ingredients.xlsx")

master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.01.2024/SRCH290292.CSV")
```

### Read Data Fixed files (Click play after inputting correct resources)
```{r}
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/07.01.2024/ProjectList_7_1_2024 9_07_49 AM.xlsx")
