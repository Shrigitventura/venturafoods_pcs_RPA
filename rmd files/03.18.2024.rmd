...
```{r}
mfg_location_tab_raw <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/03.18.2024/All PCS Projects - With MFG Locations (98).csv")

pcs_rnd_primary_pack_graphics <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/03.18.2024/PCS R&D Primary & Pack Graphics (72).csv")
...
rnd_unique_ingredient_info <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/03.18.2024/PCS R&D Unique Ingredients (73).csv")

master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/03.18.2024/SRCH872206.csv")
```

### Read Data Fixed files (Click play after inputting correct resources)
```{r}
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/03.18.2024/ProjectList_3_18_2024 8_03_46 AM.xlsx")
...
```{r}
comp <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 03.11.2024.xlsx") 
```
...
mfg_location_tab_raw %>% 
  janitor::clean_names() %>% 
  dplyr::filter(project_submitted_date >= as.Date("2024-03-10") & project_submitted_date <= as.Date("2024-03-17")) %>%
  dplyr::select(project_number) -> new_projects
```

### input Previous week's data
```{r}
mpi <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 03.11.2024.xlsx")
clean_customer <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 03.11.2024.xlsx")
```
...
```{r}
writexl::write_xlsx(comp_update_2, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 03.18.2024.xlsx")
writexl::write_xlsx(new_projects_mpi_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 03.18.2024.xlsx")
writexl::write_xlsx(clean_customer_new_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 03.18.2024.xlsx")
...
```{r}
writexl::write_xlsx(mfg_location_tab, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/03.18.2024/mfg_location_tab_03.18.2024.xlsx")

writexl::write_xlsx(list_of_dfs, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/03.18.2024/pcs_data_03.18.2024.xlsx")
