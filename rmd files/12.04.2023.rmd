...
```{r}
mfg_location_tab_raw <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/12.04.23/All PCS Projects - With MFG Locations (80).csv")

pcs_rnd_primary_pack_graphics <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/12.04.23/PCS R&D Primary & Pack Graphics (57).csv")
...
rnd_unique_ingredient_info <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/12.04.23/PCS R&D Unique Ingredients (58).csv")

master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/12.04.23/SRCH468996.csv")
```

### Read Data Fixed files (Click play after inputting correct resources)
```{r}
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2023/12.04.23/ProjectList_12_4_2023 5_32_35 AM.xlsx")
...
mfg_location_tab_raw %>% 
  janitor::clean_names() %>% 
  dplyr::filter(project_submitted_date >= as.Date("2023-11-26") & project_submitted_date <= as.Date("2023-12-03")) %>%
...
```{r}
writexl::write_xlsx(comp_update_2, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 12.04.23.xlsx")
writexl::write_xlsx(new_projects_mpi_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 12.04.2023.xlsx")
writexl::write_xlsx(clean_customer_new_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 12.04.2023.xlsx")
...
```{r}
writexl::write_xlsx(mfg_location_tab, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2023/12.04.2023/mfg_location_tab_12.04.2023.xlsx")

writexl::write_xlsx(list_of_dfs, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2023/12.04.2023/pcs_data_12.04.2023.xlsx")
