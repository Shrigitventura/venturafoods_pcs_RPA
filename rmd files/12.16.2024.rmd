...
```{r}
mfg_location_tab_raw <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/12.09.2024/All PCS Projects - With MFG Loc (15).xlsx")

pcs_rnd_primary_pack_graphics <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/12.09.2024/PCS R&D Primary & Pack Graphics (15).xlsx")
...
rnd_unique_ingredient_info <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/12.09.2024/PCS R&D Unique Ingredients (15).xlsx")

master_data <- read_csv("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/12.09.2024/SRCH888649.csv")
```

### Read Data Fixed files (Click play after inputting correct resources)
```{r}
coordinator <- read_excel("S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/PCS Weekly Raw Data/2024/12.09.2024/ProjectList_12_9_2024 2_13_27 PM.xlsx")
...
mfg_location_tab_raw %>% 
  ...
  dplyr::filter(project_submitted_date >= as.Date("2024-11-25") & project_submitted_date <= as.Date("2024-12-02")) %>%
...
```{r}
writexl::write_xlsx(comp_update_2, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PRM Status Update/PRM Status 12.09.2024.xlsx")
writexl::write_xlsx(new_projects_mpi_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/MPI/MPI 12.09.2024.xlsx")
writexl::write_xlsx(clean_customer_new_added, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/Customer Clean/Customer Clean 12.09.2024.xlsx")
...
```{r}
writexl::write_xlsx(mfg_location_tab, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/12.09.2024/mfg_location_tab_12.09.2024.xlsx")

writexl::write_xlsx(list_of_dfs, "S:/Global Shared Folders/Large Documents/S&OP/PCS/Reporting/RStudio/PCS Weekly files from RStudio/2024/12.09.2024/pcs_data_12.09.2024.xlsx")
